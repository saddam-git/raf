...
class ActivationMailFormMixin:
    ...
    def set_mail_sent(self,value):
        raise TypeError('Cannot set mail sent attribute')
    ...
    def send_mail(self,user,**kwargs):
        ...
        if not self.mail_sent:self.add_error(None,ValidationError(self.mail_validation_error,code=error))
        return self.mail_sent
